...
import PracticeAdvancedConceptRoutes from "./Common/routes/index";
        ...
        <Router basename={process.env.PUBLIC_URL}>
          <div>
            <Switch>
              ...
              <Route path="/country">
                <CountriesDashboard
                  themeObject={this.mode[this.getCurrentTheme()]}
                  change={this.setCurrentTheme}
                />
              </Route>
              <Router
                path="/countryCard"
              ...
              <Route path="/gridGame">
                <GridMemoryGame
                  themeObject={this.mode[this.getCurrentTheme()]}
                  changeTheme={this.setCurrentTheme}
                />
              </Route>
