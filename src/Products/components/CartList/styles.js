...
const CartContainer=styled.div`${tw`bg-gray-900 flex fixed top-0 right-0 flex-col z-10 `};
...
export{CartContainer,CartImage,CartPage,CloseButton,InnerCartImage,CartHeading,
    SelectedProducts,Products,CheckOutTag,Count}